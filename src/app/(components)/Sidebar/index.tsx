...
import { AlertCircle, AlertOctagon, AlertTriangle, Briefcase, BriefcaseBusiness, ChevronDown, ChevronUp, Home, Icon, Layers3, LockIcon, LucideIcon, Search, Settings, ShieldAlert, User, Users, X } from 'lucide-react';
      ...
      <div className={sidebarClassNames}>
        <div className="flex h-[100%] w-full flex-col justify-start">
          ...
          <nav className='z-10 w-full'>
            ...
            <SidebarLink icon={User} lable="User" href='/user' />
            <SidebarLink icon={Users} lable="Users" href='/users' />
          </nav>
